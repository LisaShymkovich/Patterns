...
const string MENU_STRING_DRIVE_E = "Choose the crossbow material (1 - Aluminum, 2 - Wood, 3 - Plastic): ";
...
const string MENU_STRING_TYPE_ET = "Choose the crossbow type (1- Block, 2 - Recurve ): ";
