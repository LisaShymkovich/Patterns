...
const string MENU_STRING_Knife_T = "Choose knife type(1 - Trench, 2 - Bayonets, 3-Karambit, 4- Machetes): ";
...
const string MENU_STRING_Mat_T = "Choose knife material (1 - Steel, 2 - Titanium, 3- Ceramics): ";
...
const string MENU_STRING_Blade_SH = "Choose the knife shape(1 - Bowie, 2 - Kukri, 3 - Tanto, 4 - Dagger): ";
